...
class ProfileGalleryView extends StatefulWidget {
  ProfileGalleryView({Key key}) : super(key: key);

  @override
  _ProfileGalleryViewState createState() => _ProfileGalleryViewState();
}

class _ProfileGalleryViewState extends State<ProfileGalleryView> {
